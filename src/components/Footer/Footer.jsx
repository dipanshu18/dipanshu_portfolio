...
export default function Footer() {
  return (
    <footer id="contact_me" className="py-20 bg-red-400">
      <h1 className="text-center pb-10 text-3xl lg:text-6xl text-red-900 font-extrabold">
        Contact Me
      </h1>
      <h1 className="text-center pb-4 text-red-100 text-xl lg:text-3xl font-semibold">
        Feel free to connect with me and contact for further discussions.
      </h1>
      <h3 className="text-center pb-4 text-red-100 text-lg lg:text-2xl font-light">
      ...
      <p className="text-center pb-2 text-red-200 text-md lg:text-lg font-normal max-w-xl mx-auto">
